...
function Player(data, listener, system) {
  ...
  Object.defineProperty(_this, 'state', {
    get: () => getState(state, _this.coordinator ? _this.coordinator._state : state, _this.hasSub ? _this.sub : null)
  });
...
Player.prototype.toJSON = function toJSON() {
  return {
    ...
    state: this.state,
    groupState: this.coordinator ? this.coordinator.groupState : this.groupState,
